...
def toggle_handle_selection(handle_direction: str, extend: bool, visible_objects: list) -> None:
...
def all_keyframes_have_selected_handle(obj: bpy.types.Object, handle_direction: str) -> bool:
...
def toggle_keyframe_handle_selection(obj: bpy.types.Object, 
                                     handle_direction: str, 
                                     extend: bool, 
